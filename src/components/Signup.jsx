...
const[sentnametologin,setsendnametologin]=useState(null)
 ...
 const handelTologinClick =()=>{
  ...
  {toLogin? (<Login  sentnametologin={sentnametologin} setConvertArray={setConvertArray} convertArray={convertArray}/>):( <div style={{ padding:'30px',display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '40px' }}>
