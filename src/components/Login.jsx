...
const Login = ({sentnametologin,convertArray,setConvertArray}) => {
...
const handelSubmit = (e)=>{
  ...
  <div>
             {toSignup? (<Signup/>): ( <div >
              {toHome?(<Home  setToHome={setToHome} setConvertArray={setConvertArray} convertArray={convertArray}  name={sendPTH}/>):(
                <div
                style={{
                  display: "flex",
                  alignItems: "center",
              ...
              <span style={{fontSize:'30px',color:'orangered',fontWeight:'bold'}}>Hi {sentnametologin}</span>
